...
const RAW_TRIPS: RawTrip[] = [
  ...
  {
    // Event template: 2026 Italian GP at Monza (Sep 4-6). Budget: 3d × Milan 130 USD/day = 390 USD.
    id: "monza-f1-2026",
    title: "Monza F1 2026 Race Weekend (Italian GP)",
    coverImage: null,
    gradient: "from-red-600 to-emerald-800",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 3,
    estimatedCost: 390,
    currency: "USD",
    tags: ["Sports", "Events", "Foodie"],
    excerpt:
      "Formula 1's Temple of Speed from a Milan base — Friday arrival with Duomo rooftops and aperitivo, Saturday's train out to Monza for qualifying, and Sunday's Italian Grand Prix followed by a celebration dinner back in the city.",
    weatherTip:
      "The 2026 Italian Grand Prix at Monza runs September 4-6. Early September in Lombardy is warm and can be muggy — check the official Formula 1 site for the session schedule and buy tickets only through the official promoter.",
    fullDays: [
      {
        day: 1,
        theme: "Milan arrival",
        activities: [
          { time: "13:00", name: "Check in near the Duomo or Porta Venezia", emoji: "🏨" },
          { time: "15:00", name: "Duomo di Milano rooftop terraces", emoji: "⛪" },
          { time: "18:00", name: "Aperitivo in the Galleria & Brera lanes", emoji: "🍹" },
          { time: "20:30", name: "Risotto alla milanese dinner", emoji: "🥘" },
        ],
      },
      {
        day: 2,
        theme: "Monza qualifying Saturday",
        activities: [
          { time: "08:30", name: "Train from Milano Centrale to Monza", emoji: "🚆" },
          { time: "Morning", name: "Parco di Monza gates & fan zone", emoji: "🎪" },
          { time: "Afternoon", name: "Qualifying at the Autodromo Nazionale Monza", emoji: "🏁" },
          { time: "Evening", name: "Monza Cathedral stroll in the old town", emoji: "⛪" },
          { time: "20:30", name: "Train back to Milan · Navigli aperitivo", emoji: "🌉" },
        ],
      },
      {
        day: 3,
        theme: "Race Sunday",
        activities: [
          { time: "Early", name: "Train from Milano Centrale to Monza", emoji: "🚆" },
          { time: "Morning", name: "Fan village & trackside atmosphere", emoji: "🎪" },
          { time: "Afternoon", name: "Italian Grand Prix at the Temple of Speed", emoji: "🏎️" },
          { time: "Evening", name: "Return to Milan for a celebration dinner", emoji: "🍝" },
          { time: "22:00", name: "Nightcap in Brera", emoji: "🍸" },
        ],
      },
    ],
    restaurants: [
      { name: "Luini", cuisine: "Panzerotti bakery", emoji: "🥟" },
      { name: "Trattoria Milanese", cuisine: "Milanese classics", emoji: "🥘" },
      { name: "Ratanà", cuisine: "Modern Milanese", emoji: "🍚" },
    ],
    city: "Milan",
    country: "Italy",
    airport: {
  ...
  {
    // Event template: 2026 Spanish GP at Madring, Madrid (Sep 11-13). Budget: 3d × Madrid 110 USD/day = 330 USD.
    id: "madrid-f1-2026",
    title: "Madrid F1 2026 Race Weekend (Spanish GP at Madring)",
    coverImage: null,
    ...
    tags: ["Sports", "Events", "Foodie"],
    excerpt:
      "Formula 1's newest street race on the Madring circuit at IFEMA Madrid — Retiro and Prado mornings, Saturday qualifying, and a Sunday race capped with a late tapas night in La Latina.",
    weatherTip:
      "The 2026 Spanish Grand Prix on Madrid's new Madring street circuit runs September 11-13. September is warm and sunny with cool evenings — check the official Formula 1 site for the session schedule and buy tickets through the official promoter.",
    fullDays: [
      {
        day: 1,
        theme: "Madrid arrival",
        activities: [
          { time: "13:00", name: "Check in near Gran Vía or Barrio de las Letras", emoji: "🏨" },
          { time: "14:30", name: "Tapas lunch around Plaza Mayor", emoji: "🥘" },
          { time: "16:30", name: "Retiro Park rowboats & Palacio de Cristal", emoji: "🌳" },
          { time: "18:30", name: "Museo del Prado — Velázquez & Goya", emoji: "🖼️" },
          { time: "21:30", name: "Vermut & raciones in La Latina", emoji: "🍷" },
        ],
      },
      {
        day: 2,
        theme: "Madring qualifying Saturday",
        activities: [
          { time: "Morning", name: "Metro lines 5/8 out to IFEMA Madrid · Madring gates", emoji: "🚇" },
          { time: "Midday", name: "Fan zone around the Madring street circuit", emoji: "🎪" },
          { time: "Afternoon", name: "Qualifying on the Madring street circuit", emoji: "🏁" },
          { time: "Evening", name: "Sunset at the Temple of Debod", emoji: "🌅" },
          { time: "21:30", name: "Raciones & rioja on Cava Baja", emoji: "🍷" },
        ],
      },
      {
        day: 3,
        theme: "Race Sunday",
        activities: [
          { time: "Morning", name: "Metro to IFEMA for the Madring fan zone", emoji: "🎪" },
          { time: "Afternoon", name: "Spanish Grand Prix on the Madring street circuit", emoji: "🏎️" },
          { time: "Evening", name: "Churros con chocolate at San Ginés", emoji: "🍫" },
          { time: "22:00", name: "Rooftop nightcap above Gran Vía", emoji: "🌙" },
        ],
      },
    ],
    restaurants: [
      { name: "Casa Labra", cuisine: "Tapas bar", emoji: "🐟" },
      { name: "Mercado de San Miguel", cuisine: "Market hall", emoji: "🥘" },
      { name: "Sobrino de Botín", cuisine: "Castilian", emoji: "🍖" },
    ],
    city: "Madrid",
    country: "Spain",
    airport: {
  ...
  {
    // Event template: 2026 Azerbaijan GP, Baku City Circuit (Sep 24-26). Budget: 3d × Baku 80 USD/day = 240 USD.
    id: "baku-f1-2026",
    title: "Baku F1 2026 Race Weekend (Azerbaijan GP)",
    coverImage: null,
    gradient: "from-sky-600 to-emerald-800",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 3,
    estimatedCost: 240,
    currency: "USD",
    tags: ["Sports", "Culture", "Events"],
    excerpt:
      "The fastest street circuit in Formula 1, threading Baku's seafront past the Maiden Tower and the old walled city — with Icherisheher mornings, Boulevard sunsets and three days of racing.",
    weatherTip:
      "The 2026 Azerbaijan Grand Prix on the Baku City Circuit runs September 24-26. Late September on the Caspian coast is warm and dry — check the official Formula 1 site for the session schedule and buy tickets through the official promoter.",
    fullDays: [
      {
        day: 1,
        theme: "Old city Friday",
        activities: [
          { time: "13:00", name: "Check in near Icherisheher or the Boulevard", emoji: "🏨" },
          { time: "15:00", name: "Icherisheher — Maiden Tower & Shirvanshah Palace", emoji: "🏰" },
          { time: "17:30", name: "Baku Boulevard stroll on the Caspian waterfront", emoji: "🌊" },
          { time: "20:00", name: "Kebab & plov dinner in the old city", emoji: "🍢" },
        ],
      },
      {
        day: 2,
        theme: "Qualifying Saturday",
        activities: [
          { time: "Morning", name: "Flame Towers view from Highland Park", emoji: "🔥" },
          { time: "Midday", name: "Walk to the Baku City Circuit gates", emoji: "🚶" },
          { time: "Afternoon", name: "Qualifying on the Baku City Circuit", emoji: "🏁" },
          { time: "Evening", name: "Azerbaijan Carpet Museum on the Boulevard", emoji: "🧶" },
          { time: "21:00", name: "Seaside dinner along the promenade", emoji: "🍽️" },
        ],
      },
      {
        day: 3,
        theme: "Race Sunday",
        activities: [
          { time: "Morning", name: "Fan zone & village near the circuit", emoji: "🎪" },
          { time: "Afternoon", name: "Azerbaijan Grand Prix on the Baku City Circuit", emoji: "🏎️" },
          { time: "Evening", name: "Fountain Square celebration stroll", emoji: "⛲" },
          { time: "Night", name: "Flame Towers light show across the bay", emoji: "✨" },
        ],
      },
    ],
    restaurants: [
      { name: "Firuza", cuisine: "Azerbaijani", emoji: "🍲" },
      { name: "Nargiz", cuisine: "Kebab house", emoji: "🍢" },
      { name: "Sumakh", cuisine: "Modern Azerbaijani", emoji: "🥗" },
    ],
    city: "Baku",
    country: "Azerbaijan",
    airport: {
  ...
  {
    // Event template: 2026 Abu Dhabi GP season finale, Yas Marina (Dec 4-6). Budget: 3d × Abu Dhabi 180 USD/day = 540 USD.
    id: "abu-dhabi-f1-2026",
    title: "Abu Dhabi F1 2026 Season Finale (Yas Marina)",
    coverImage: null,
    ...
    estimatedCost: 540,
    currency: "USD",
    tags: ["Sports", "Events", "Luxury"],
    excerpt:
      "The 2026 season decider at Yas Marina Circuit — Sheikh Zayed Grand Mosque serenity on arrival, Yas Island thrills before qualifying, and a Sunday race that starts in sunshine and ends under floodlights.",
    weatherTip:
      "The 2026 Abu Dhabi Grand Prix at Yas Marina runs December 4-6. December days are warm and nights balmy, and the race famously runs from daylight into darkness — check the official Formula 1 site for the session schedule and buy tickets through official channels.",
    fullDays: [
      {
        day: 1,
        theme: "Arrival & the Grand Mosque",
        activities: [
          { time: "12:00", name: "Check in on Yas Island or the Corniche", emoji: "🏨" },
          { time: "16:00", name: "Sheikh Zayed Grand Mosque at golden hour", emoji: "🕌" },
          { time: "19:30", name: "Dates & Arabic coffee welcome", emoji: "☕" },
          { time: "20:30", name: "Waterfront dinner along the Corniche", emoji: "🌃" },
        ],
      },
      {
        day: 2,
        theme: "Yas Island & qualifying",
        activities: [
          { time: "09:30", name: "Ferrari World Abu Dhabi coasters", emoji: "🎢" },
          { time: "Afternoon", name: "Qualifying under the Yas Marina lights", emoji: "🏁" },
          { time: "Evening", name: "Yas Marina promenade & superyacht docks", emoji: "🛥️" },
          { time: "21:00", name: "Yas Bay waterfront dinner", emoji: "🍽️" },
        ],
      },
      {
        day: 3,
        theme: "Race Sunday — day into night",
        activities: [
          { time: "Morning", name: "Yas Island fan village & trackside walks", emoji: "🎪" },
          { time: "Afternoon", name: "Abu Dhabi Grand Prix — sunset into floodlights", emoji: "🏎️" },
          { time: "Night", name: "Yasalam after-race concerts on Yas Island", emoji: "🎵" },
          { time: "Late", name: "Corniche nightcap under the palms", emoji: "🌴" },
        ],
      },
    ],
    restaurants: [
      { name: "Li Beirut", cuisine: "Lebanese", emoji: "🫓" },
      { name: "Hakkasan Abu Dhabi", cuisine: "Cantonese", emoji: "🥢" },
      { name: "Al Mrzab", cuisine: "Emirati", emoji: "🍛" },
    ],
    city: "Abu Dhabi",
    country: "UAE",
    airport: {
  ...
  {
    // Seasonal template: Rovaniemi Christmas / Arctic Circle (Dec). Budget: 4d × Rovaniemi 180 USD/day = 720 USD.
    id: "lapland-christmas-2026",
    title: "Lapland Christmas 2026: Rovaniemi Arctic Escape",
    coverImage: null,
    gradient: "from-emerald-400 to-purple-800",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 4,
    estimatedCost: 720,
    currency: "USD",
    tags: ["Christmas", "Nature", "Adventure"],
    excerpt:
      "Christmas above the Arctic Circle in Santa's official hometown — crossing the line at Santa Claus Village, reindeer and husky sledding through snowy forests, aurora hunting after dark, and fireside Lappish dinners.",
    weatherTip:
      "December in Rovaniemi brings deep snow, polar-night twilight and temperatures well below freezing — layer a thermal base, mid layer and insulated outer shell with warm boots, mittens and a hat rather than one thick coat. Book safaris and Santa Claus Village visits ahead, and remember auroras need clear skies.",
    fullDays: [
      {
        day: 1,
        theme: "Arctic Circle arrival",
        activities: [
          { time: "13:00", name: "Land at Rovaniemi & transfer to the Arctic Circle", emoji: "✈️" },
          { time: "15:00", name: "Santa Claus Village — meet Santa & cross the Arctic Circle line", emoji: "🎅" },
          { time: "17:00", name: "Arctic Circle post office — postcards from 66°N", emoji: "📮" },
          { time: "19:00", name: "Lappish dinner — reindeer stew & cloudberry dessert", emoji: "🍲" },
          { time: "21:00", name: "First northern lights check", emoji: "🌌" },
        ],
      },
      {
        day: 2,
        theme: "Reindeer & husky day",
        activities: [
          { time: "09:30", name: "Reindeer sled ride through snowy forest", emoji: "🦌" },
          { time: "12:30", name: "Campfire lunch in a Lappish kota hut", emoji: "🔥" },
          { time: "15:00", name: "Husky sledding across the fells", emoji: "🐕" },
          { time: "18:00", name: "Sauna & lodge dinner", emoji: "♨️" },
          { time: "21:30", name: "Aurora hunting by minibus", emoji: "🌌" },
        ],
      },
      {
        day: 3,
        theme: "Rovaniemi town & Arktikum",
        activities: [
          { time: "10:00", name: "Arktikum museum — Arctic science & Sámi culture", emoji: "🏛️" },
          { time: "13:00", name: "Lunch by the frozen Kemijoki river", emoji: "🥣" },
          { time: "15:00", name: "Pilke Science Centre & Christmas street lights", emoji: "🎄" },
          { time: "18:30", name: "Gingerbread baking & glögi evening", emoji: "🍪" },
        ],
      },
      {
        day: 4,
        theme: "Farewell Lapland",
        activities: [
          { time: "09:00", name: "Snowshoe walk through the silent forest", emoji: "🎿" },
          { time: "12:00", name: "Farewell lunch & souvenir shopping", emoji: "🎁" },
          { time: "14:00", name: "Arctic Circle certificate & last photos", emoji: "📸" },
          { time: "16:00", name: "Airport transfer for an evening flight", emoji: "✈️" },
        ],
      },
    ],
    restaurants: [
      { name: "Restaurant Nili", cuisine: "Lappish", emoji: "🦌" },
      { name: "Restaurant Aitta", cuisine: "Classic Finnish", emoji: "🍲" },
      { name: "Rakas Restaurant", cuisine: "Arctic fine dining", emoji: "❄️" },
    ],
    city: "Rovaniemi",
    country: "Finland",
    airport: {
  ...
  {
    // Route template: Tokyo → Kyoto → Osaka → Tokyo solo rail trip. Budget: 7d × Tokyo 120 USD/day = 840 USD.
    id: "solo-japan-7-day",
    title: "Solo Japan 7-Day Golden Route",
    coverImage: null,
    ...
    estimatedCost: 840,
    currency: "USD",
    tags: ["Solo Travel", "Culture", "Foodie"],
    excerpt:
      "One traveller, one rail ticket, seven days — Tokyo's solo dining counters and neon alleys, the shinkansen south to Kyoto's temples, a day in Osaka's kitchen, and a final night back in Shibuya.",
    weatherTip:
      "Aim for late March–April (blossoms) or October–November (foliage) for comfortable city walking. Japan is one of the safest solo destinations on earth: capsule hotels and hostels make solo stays easy, and a full rail pass generally pays off on a Tokyo–Kyoto–Osaka–Tokyo spine.",
    fullDays: [
      {
        day: 1,
        theme: "Tokyo arrival",
        activities: [
          { time: "14:00", name: "Capsule hotel check-in in Asakusa", emoji: "🛏️" },
          { time: "16:00", name: "Konbini run & Sumida river walk", emoji: "🏪" },
          { time: "18:30", name: "Solo ramen counter dinner", emoji: "🍜" },
          { time: "20:30", name: "Shinjuku Golden Gai tiny-bar hop", emoji: "🏮" },
        ],
      },
      {
        day: 2,
        ...
        activities: [
          { time: "08:30", name: "Senso-ji in Asakusa before the crowds", emoji: "⛩️" },
          { time: "11:00", name: "Ueno Park & Tokyo National Museum", emoji: "🏯" },
          { time: "14:30", name: "Akihabara arcades & retro games", emoji: "🕹️" },
          { time: "19:00", name: "Solo-booth tonkotsu ramen dinner", emoji: "🍥" },
        ],
      },
      {
        day: 3,
        theme: "Tokyo modern",
        activities: [
          { time: "09:00", name: "Meiji Shrine & Harajuku backstreets", emoji: "🌳" },
          { time: "12:00", name: "Shibuya Crossing & scramble views", emoji: "🚦" },
          { time: "15:00", name: "Shimokitazawa vintage thrift crawl", emoji: "👕" },
          { time: "19:00", name: "Omoide Yokocho yakitori alley", emoji: "🍢" },
        ],
      },
      {
        day: 4,
        ...
        activities: [
          { time: "08:00", name: "Shinkansen from Tokyo Station to Kyoto", emoji: "🚄" },
          { time: "11:30", name: "Fushimi Inari torii-gate hike", emoji: "⛩️" },
          { time: "16:00", name: "Gion lanes & Yasaka Shrine at dusk", emoji: "🎐" },
          { time: "19:00", name: "Counter dinner in Pontocho alley", emoji: "🍶" },
        ],
      },
      {
        day: 5,
        theme: "Kyoto depth",
        activities: [
          { time: "08:00", name: "Arashiyama bamboo grove early", emoji: "🎋" },
          { time: "10:30", name: "Tenryu-ji temple & gardens", emoji: "🪷" },
          { time: "14:00", name: "Kinkaku-ji, the Golden Pavilion", emoji: "✨" },
          { time: "17:30", name: "Tea ceremony & matcha in a machiya", emoji: "🍵" },
        ],
      },
      {
        day: 6,
        theme: "Osaka day trip",
        activities: [
          { time: "08:30", name: "Express train to Osaka", emoji: "🚆" },
          { time: "10:00", name: "Osaka Castle park & keep", emoji: "🏯" },
          { time: "13:00", name: "Kuromon Market street lunch", emoji: "🐙" },
          { time: "16:00", name: "Dotonbori neon & Glico sign", emoji: "🎡" },
          { time: "19:00", name: "Kushikatsu & takoyaki in Shinsekai", emoji: "🍢" },
          { time: "21:30", name: "Return train to Kyoto", emoji: "🚃" },
        ],
      },
      {
        day: 7,
        theme: "Back to Tokyo",
        activities: [
          { time: "09:00", name: "Shinkansen back to Tokyo", emoji: "🚄" },
          { time: "12:30", name: "Tokyo Character Street souvenir run", emoji: "🎁" },
          { time: "15:00", name: "teamLab digital-art immersion", emoji: "🌀" },
          { time: "18:30", name: "Farewell sushi counter dinner", emoji: "🍣" },
          { time: "21:00", name: "Final Shibuya night walk", emoji: "🌃" },
        ],
      },
    ],
    restaurants: [
      { name: "Ichiran Ramen", cuisine: "Tonkotsu ramen", emoji: "🍜" },
      { name: "Honke Owariya", cuisine: "Kyoto soba", emoji: "🥢" },
      { name: "Kura Sushi", cuisine: "Conveyor-belt sushi", emoji: "🍣" },
    ],
    city: "Tokyo",
    country: "Japan",
    airport: {
  ...
  {
    // Route template: Rome → Florence → Bologna → Venice by train. Budget: 10d × Rome 130 EUR/day = 1300 EUR.
    id: "slow-travel-italy-10-day",
    title: "Slow Travel Italy: 10 Days by Train",
    coverImage: null,
    ...
    estimatedCost: 1300,
    currency: "EUR",
    tags: ["Slow Travel", "Foodie", "History"],
    excerpt:
      "Ten days, four cities, zero rental cars — Rome, Florence, Bologna and Venice linked by high-speed and regional trains, with long lunches, an agriturismo day in Chianti, and only four hotel changes.",
    weatherTip:
      "April to June and September to October offer the best mix of walking weather and thinner crowds. The slow-travel logic: unpack in each city for two or three nights and let regional trains, not the itinerary, set the pace.",
    fullDays: [
      {
        day: 1,
        theme: "Rome arrival",
        activities: [
          { time: "14:00", name: "Check in near Monti or Trastevere — base for 3 nights", emoji: "🏨" },
          { time: "17:00", name: "Piazza Navona & Pantheon golden-hour walk", emoji: "⛲" },
          { time: "20:00", name: "Trastevere trattoria dinner", emoji: "🍝" },
        ],
      },
      {
        day: 2,
        theme: "Ancient Rome",
        activities: [
          { time: "09:00", name: "Colosseum, Roman Forum & Palatine loop", emoji: "🏟️" },
          { time: "13:30", name: "Long Roman lunch in Monti", emoji: "🍷" },
          { time: "16:00", name: "Capitoline Museums terrace views", emoji: "🏛️" },
          { time: "19:30", name: "Gelato passaggiata by the Trevi Fountain", emoji: "🍦" },
        ],
      },
      {
        day: 3,
        theme: "Vatican & quiet corners",
        activities: [
          { time: "08:30", name: "Vatican Museums & Sistine Chapel", emoji: "🎨" },
          { time: "12:30", name: "Borghese Gallery & gardens stroll", emoji: "🌳" },
          { time: "17:30", name: "Aperitivo in Campo de' Fiori", emoji: "🍹" },
        ],
      },
      {
        day: 4,
        theme: "Train to Florence",
        activities: [
          { time: "09:30", name: "High-speed train Roma Termini → Firenze S.M.N.", emoji: "🚄" },
          { time: "12:00", name: "Check in near Santo Spirito — base for 3 nights", emoji: "🧳" },
          { time: "15:00", name: "Duomo & Brunelleschi's dome", emoji: "⛪" },
          { time: "18:30", name: "Sunset at Piazzale Michelangelo", emoji: "🌇" },
        ],
      },
      {
        day: 5,
        theme: "Florence art",
        activities: [
          { time: "09:00", name: "Uffizi Gallery masterpieces", emoji: "🖼️" },
          { time: "13:00", name: "Lampredotto panino lunch", emoji: "🥪" },
          { time: "15:30", name: "Ponte Vecchio & Oltrarno artisans", emoji: "🪚" },
          { time: "20:00", name: "Bistecca alla fiorentina dinner", emoji: "🥩" },
        ],
      },
      {
        day: 6,
        theme: "Chianti agriturismo day",
        activities: [
          { time: "09:00", name: "Regional train & short ride out to a Chianti agriturismo", emoji: "🍇" },
          { time: "11:00", name: "Vineyard walk & cellar tasting", emoji: "🍷" },
          { time: "13:30", name: "Farmhouse lunch at the family table", emoji: "🧀" },
          { time: "17:00", name: "Return to Florence by evening train", emoji: "🚆" },
        ],
      },
      {
        day: 7,
        theme: "Train to Bologna",
        activities: [
          { time: "09:00", name: "High-speed train to Bologna", emoji: "🚄" },
          { time: "11:00", name: "Check in near the Two Towers — base for 2 nights", emoji: "🧳" },
          { time: "15:00", name: "Piazza Maggiore & Basilica di San Petronio", emoji: "⛪" },
          { time: "17:30", name: "Quadrilatero market streets", emoji: "🥓" },
          { time: "20:00", name: "Tagliatelle al ragù dinner", emoji: "🍝" },
        ],
      },
      {
        day: 8,
        theme: "Bologna slow food",
        activities: [
          { time: "09:00", name: "Portico walk up to the San Luca sanctuary", emoji: "⛩️" },
          { time: "12:30", name: "Mortadella & tortellini lunch", emoji: "🥟" },
          { time: "15:30", name: "University quarter & Archiginnasio", emoji: "📚" },
          { time: "18:00", name: "Aperitivo beneath the Two Towers", emoji: "🍸" },
        ],
      },
      {
        day: 9,
        theme: "Train to Venice",
        activities: [
          { time: "09:30", name: "Regional train across the lagoon causeway", emoji: "🚆" },
          { time: "11:30", name: "Vaporetto down the Grand Canal", emoji: "🛶" },
          { time: "14:00", name: "Check in near Dorsoduro — base for 2 nights", emoji: "🧳" },
          { time: "16:00", name: "Zattere promenade & Giudecca views", emoji: "🌊" },
          { time: "19:30", name: "Cicchetti & ombra bacaro crawl", emoji: "🍷" },
        ],
      },
      {
        day: 10,
        theme: "Venice farewell",
        activities: [
          { time: "08:30", name: "St Mark's Square & Basilica morning", emoji: "⛪" },
          { time: "10:30", name: "Rialto market & bridge", emoji: "🐟" },
          { time: "13:00", name: "Long farewell lunch with a canal view", emoji: "🍝" },
          { time: "16:00", name: "Final vaporetto loop down the Giudecca", emoji: "⛴️" },
          { time: "19:00", name: "Evening train onward from Venezia S. Lucia", emoji: "🚉" },
        ],
      },
    ],
    restaurants: [
      { name: "Roscioli", cuisine: "Roman deli & trattoria", emoji: "🍝" },
      { name: "All'Antico Vinaio", cuisine: "Schiacciata sandwiches", emoji: "🥪" },
      { name: "Osteria dell'Orsa", cuisine: "Bolognese osteria", emoji: "🥟" },
    ],
    city: "Rome",
    country: "Italy",
    airport: {
  ...
  {
    // City-break template: Mexico City first-timer. Budget: 3d × Mexico City 150 USD/day = 450 USD.
    id: "mexico-city-3-day",
    title: "Mexico City 3-Day First Timer",
    coverImage: null,
    gradient: "from-lime-500 to-rose-700",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 3,
    estimatedCost: 450,
    currency: "USD",
    ...
    excerpt:
      "A first-timer's long weekend — the Zócalo and Templo Mayor in the centro histórico, a morning at the Teotihuacán pyramids, and the leafy streets of Roma, Condesa and Coyoacán between them.",
    weatherTip:
      "Mexico City sits at 2,240 meters — take day one slowly, drink more water than usual and go easy on the mezcal until you're acclimated. March to May is the dry, sunny window; pack a layer for cool evenings.",
    fullDays: [
      {
        day: 1,
        theme: "Centro Histórico",
        activities: [
          { time: "13:00", name: "Check in near Roma or the centro", emoji: "🏨" },
          { time: "15:00", name: "Zócalo, Metropolitan Cathedral & Templo Mayor", emoji: "🏛️" },
          { time: "17:30", name: "Calle Madero & Casa de los Azulejos", emoji: "🟦" },
          { time: "20:00", name: "Tacos al pastor dinner", emoji: "🌮" },
        ],
      },
      {
        day: 2,
        theme: "Teotihuacán day trip",
        activities: [
          { time: "07:30", name: "Early bus north to Teotihuacán", emoji: "🚌" },
          { time: "09:00", name: "Pyramid of the Sun & Avenue of the Dead", emoji: "☀️" },
          { time: "12:30", name: "Lunch in San Juan Teotihuacán", emoji: "🍲" },
          { time: "16:00", name: "Return to the city for a slow evening", emoji: "😌" },
          { time: "20:00", name: "Dinner in Roma Norte", emoji: "🍽️" },
        ],
      },
      {
        day: 3,
        theme: "Roma, Condesa & Coyoacán",
        activities: [
          { time: "09:00", name: "Breakfast & architecture walk in Roma & Condesa", emoji: "🏡" },
          { time: "11:00", name: "Museo Nacional de Antropología highlights", emoji: "🗿" },
          { time: "14:00", name: "Metro to Coyoacán — Casa Azul & centro", emoji: "💙" },
          { time: "17:00", name: "Coyoacán market snacks & square stroll", emoji: "🫓" },
          { time: "20:00", name: "Farewell dinner in Roma Norte", emoji: "🌮" },
        ],
      },
    ],
    restaurants: [
      { name: "El Cardenal", cuisine: "Classic Mexican", emoji: "🍳" },
      { name: "Contramar", cuisine: "Seafood tostadas", emoji: "🐟" },
      { name: "Pujol", cuisine: "Modern Mexican", emoji: "🌮" },
    ],
    city: "Mexico City",
    country: "Mexico",
  ...
  // ── Orphan-repair trips: Istanbul, Antalya, Cologne ──────────────────
  {
    id: "istanbul-highlights-3d",
    title: "Istanbul Highlights in 3 Days",
    ...
    excerpt:
      "The essential Istanbul on one compact route: the two great mosques, Topkapi and the bazaars, and a Bosphorus crossing between continents.",
    weatherTip:
      "April to May and September to October are ideal — mild, mostly dry, and before the summer cruise-ship crowds peak. Winters are cold and rainy; carry a layer for the Bosphorus wind.",
    fullDays: [
      {
        day: 1,
        theme: "Sultanahmet's twin landmarks",
        activities: [
          { time: "08:30", name: "Hagia Sophia at opening, before the queues build", emoji: "🕌" },
          { time: "11:00", name: "Blue Mosque across the square", emoji: "🔷" },
          { time: "14:00", name: "Basilica Cistern's columns and Medusa heads", emoji: "💧" },
          { time: "18:00", name: "Sunset tea on a Sultanahmet rooftop", emoji: "🫖" },
        ],
      },
      {
        day: 2,
        theme: "Palaces and bazaars",
        activities: [
          { time: "09:00", name: "Topkapi Palace & the Harem (book the harem ticket)", emoji: "👑" },
          { time: "13:30", name: "Lunch in the Spice Bazaar's eyvan quarter", emoji: "🌿" },
          { time: "15:00", name: "Grand Bazaar's covered lanes and kokoreç stalls", emoji: "🛍️" },
          { time: "19:30", name: "Dinner and meyhane music in Beyoğlu", emoji: "🎻" },
        ],
      },
      {
        day: 3,
        theme: "The Bosphorus and the ferry life",
        activities: [
          { time: "10:20", name: "Public ferry from Eminönü up the Bosphorus", emoji: "⛴️" },
          { time: "13:00", name: "Fish sandwich lunch at Karaköy's docks", emoji: "🥖" },
          { time: "15:00", name: "Galata Tower and the Istiklal tram walk", emoji: "🗼" },
          { time: "18:30", name: "Hamam session, then a farewell kebap dinner", emoji: "🧖" },
        ],
      },
    ],
    restaurants: [
      { name: "Karaköy Lokantası", cuisine: "Turkish meyhane · $$", emoji: "🐟" },
      { name: "Çiya Sofrası", cuisine: "Anatolian home cooking · $", emoji: "🍲" },
      { name: "Pandeli", cuisine: "Ottoman-Greek classic · $$", emoji: "🍛" },
    ],
    city: "Istanbul",
    country: "Turkey",
    airport: {
  ...
  {
    id: "antalya-turquoise-coast",
    title: "Antalya & the Turquoise Coast, 4 Days",
    coverImage: null,
    gradient: "from-teal-500 to-cyan-700",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 4,
    estimatedCost: 320,
    currency: "USD",
    tags: ["Beaches", "Culture", "Relaxed"],
    excerpt:
      "Kaleiçi's Roman harbour, two waterfalls, a day among Lycian ruins and one deliberately empty beach afternoon — the Turkish Riviera at an unhurried pace.",
    weatherTip:
      "April to June and September to October are the comfortable windows — warm sea, walkable old town. July and August run hot; winter is mild but too cool for swimming.",
    fullDays: [
      {
        day: 1,
        theme: "Kaleiçi on foot",
        activities: [
          { time: "09:00", name: "Hadrian's Gate and the Kaleiçi lanes", emoji: "🏛️" },
          { time: "11:30", name: "The old harbour and its marina walls", emoji: "⛵" },
          { time: "14:00", name: "Antalya Museum's Lycian halls", emoji: "🏺" },
          { time: "19:00", name: "Rooftop dinner over the Roman port", emoji: "🌅" },
        ],
      },
      {
        day: 2,
        theme: "Waterfalls and the city's beaches",
        activities: [
          { time: "09:30", name: "Lower Düden waterfall, where it drops into the sea", emoji: "💦" },
          { time: "12:30", name: "Lunch at Lara beach", emoji: "🏖️" },
          { time: "16:00", name: "Upper Düden's cave walk behind the falls", emoji: "🕳️" },
          { time: "20:00", name: "Piyaz and grilled fish in the old town", emoji: "🥗" },
        ],
      },
      {
        day: 3,
        theme: "Aspendos and Perge: the classical day",
        activities: [
          { time: "08:30", name: "Aspendos Theatre — the best-preserved Roman theatre anywhere", emoji: "🎭" },
          { time: "12:00", name: "Köprüçay riverside lunch under the bridge", emoji: "🌉" },
          { time: "14:30", name: "Perge's colonnaded street and stadium", emoji: "🏟️" },
          { time: "19:30", name: "Return for a slow mezze evening", emoji: "🍤" },
        ],
      },
      {
        day: 4,
        theme: "A deliberately empty beach day",
        activities: [
          { time: "10:00", name: "Morning swim at Konyaaltı's pebble beach", emoji: "🌊" },
          { time: "13:00", name: "Beachfront kumpir and fresh orange juice", emoji: "🥔" },
          { time: "15:00", name: "Turkish hammam before the flight", emoji: "🧖" },
          { time: "18:00", name: "Farewell baklava run in the bazaar quarter", emoji: "🍯" },
        ],
      },
    ],
    restaurants: [
      { name: "Seraser Fine Dining", cuisine: "Turkish contemporary · $$$", emoji: "🍽️" },
      { name: "Vanilla Lounge", cuisine: "Mediterranean · $$", emoji: "🍋" },
      { name: "7 Mehmet", cuisine: "Classic kebap house · $$", emoji: "🍢" },
    ],
    city: "Antalya",
    country: "Turkey",
    airport: {
  ...
  {
    id: "cologne-christmas-market-weekend",
    title: "Cologne Christmas Market Weekend",
    coverImage: null,
    gradient: "from-amber-500 to-red-600",
    author: { kind: "ai", name: "tripla AI", avatarColor: "from-blue-500 to-indigo-600", initials: "AI" },
    days: 3,
    estimatedCost: 360,
    currency: "USD",
    tags: ["Christmas Markets", "Culture", "Weekend"],
    excerpt:
      "A first-Advent weekend built around Cologne's walkable market circuit: four markets around the cathedral, Kölsch breweries between them, and the Rhine after dark.",
    weatherTip:
      "Late November runs cold and damp — plan for 0-8°C evenings outdoors with a warm coat, and expect the first Advent weekend to be the busiest of the market season.",
    fullDays: [
      {
        day: 1,
        theme: "Friday — the cathedral circuit after dark",
        activities: [
          { time: "14:00", name: "Arrive; drop bags near the Hauptbahnhof or Altstadt", emoji: "🧳" },
          { time: "16:00", name: "Cologne Cathedral's façade from Roncalliplatz market", emoji: "⛪" },
          { time: "18:00", name: "Market mugs and reibekuchen at Alter Markt", emoji: "🍷" },
          { time: "20:00", name: "Kölsch service in a Früh or Gaffel brauhaus", emoji: "🍺" },
        ],
      },
      {
        day: 2,
        theme: "Saturday — the full market circuit",
        activities: [
          { time: "09:30", name: "Cathedral towers climb before the queues", emoji: "🔔" },
          { time: "11:30", name: "Hohenzollern Bridge love-lock walk", emoji: "🔗" },
          { time: "13:00", name: "Stadtgarten or Belgian Quarter lunch", emoji: "🥨" },
          { time: "15:00", name: "Market circuit: Heumarkt, Alter Markt, Rudolfplatz", emoji: "🎁" },
          { time: "19:00", name: "Harbour market and Rhine promenade at night", emoji: "🌉" },
        ],
      },
      {
        day: 3,
        theme: "Sunday — museums and the last mugs",
        activities: [
          { time: "10:00", name: "Museum Ludwig or the Chocolate Museum", emoji: "🍫" },
          { time: "13:00", name: "Late lunch in the Belgian Quarter", emoji: "🥘" },
          { time: "15:00", name: "Final market pass for gifts and mug refills", emoji: "🧸" },
          { time: "17:30", name: "Train or flight home", emoji: "🚆" },
        ],
      },
    ],
    restaurants: [
      { name: "Früh am Dom", cuisine: "Kölsch brewery classics · $$", emoji: "🍺" },
      { name: "Peters Brauhaus", cuisine: "Rhenish comfort food · $$", emoji: "🍖" },
      { name: "Ox & Klee", cuisine: "Modern German tasting · $$$$", emoji: "🍷" },
    ],
    city: "Cologne",
    country: "Germany",
    airport: {
